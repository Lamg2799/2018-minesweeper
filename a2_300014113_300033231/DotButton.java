...
public class DotButton extends JButton {
  ...
  /**
   * represents the column the dotbutton is in on the board
   */
  
  private int column;
  /**
   * represents the icon to use based on the number system, reprsenting the neighbooring mines, the mined squares, etc
   */
  
  private int iconNumber;
  /**
   * represents the row the dotbutton is in on the board
   */
  private int row;
